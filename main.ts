...
export function getSameData(num:number){
...
export function getRawData(num:number){
    num = num-1;
    let s:Array<number[]>=[];
    for (let i = num; i < num+1; i++) {
...
export function getSameSelectNum(num:number){
...
export  function randomRangeInt(start:number,num:number){
   return  Math.floor((Math.random() * num ));
}


export function GetLevelParam(level:number){
    return  [parseInt(LevelData[level-1]['level#number']),
        parseInt(LevelData[level-1]['rail_full_num#number']),
        parseInt(LevelData[level-1]['rail_empty_num#number']),
        parseInt(LevelData[level-1]['repeat_num#number']),
        parseInt(LevelData[level-1]['same_link_num#number'])];
}
